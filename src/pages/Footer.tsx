...
function FeedbackFab({ onClick }: { onClick: () => void }) {
  return (
    <button type="button" className="feedback-fab" onClick={onClick} aria-label="Send feedback">
      <svg
        width="16"
        height="16"
        viewBox="0 0 24 24"
...
export default function Footer({ authed = false }: { authed?: boolean }) {
  ...
  return (
    <>
      ...
      {authed && <FeedbackFab onClick={() => setPanel("feedback")} />}
