...
export const PATCH_NOTES: PatchNote[] = [
  {
    ...
    changes: [
      ...
      "The League Shape chart uses two signals at once. Five colours, each appearing once filled and once outlined, which is how nine cells stay distinct without inventing nine colours. Same colour means the same idea at a different depth: rising and stockpiling are both purple, on fumes and rebuild are both orange.",
      "Red appears exactly once, so yard sale is the one unmistakable cell on the board.",
