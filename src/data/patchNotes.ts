...
export const PATCH_NOTES: PatchNote[] = [
  {
    ...
    changes: [
      ...
      "The League Shape chart now uses two signals at once. Colour says which band you are in, and whether a cell is filled or outlined says how settled it is. Solid means a verdict, winning or in trouble; outlined means the middle of the board where nothing has resolved. Beauty is outlined in the brand colour, so the best roster in your league is a cut-out rather than another dot.",
      "Purple and orange join the chart. The right hand column now runs yellow, orange, red top to bottom, so a thinning future reads as one continuous warning, and yard sale is the only red on the board.",
