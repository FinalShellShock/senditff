...
// Content hash of everything that decides which trades get suggested. Logged
// feedback carries this, so a thumbs-down stays pinned to the exact engine
// that produced it and nobody has to remember to bump a version string.
